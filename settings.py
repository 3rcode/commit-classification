...
github_token = "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"
HEADERS = {
...
BOT = re.compile(r"/(?:bot|jenkins|travis|circleci|github-actions|dependabot|codecov|greenkeeper|renovate|commitlint|husky|probot|octokit)\b/i")
